...
const LandingPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "100% refund within 14 days if you're not satisfied. No questions asked."
    }
  ];
      ...
      <section className="relative bg-gradient-to-br from-gray-50 to-white pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            >
              <button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-4 px-8 rounded-lg text-lg transition-colors duration-200 flex items-center gap-2">
                Start Free Trial
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              You're not alone. Thousands of sellers face these exact problems every day.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Amazon's AI auto-detects non-compliant images faster than ever. One bad photo = suppressed listing = lost sales."
              },
              {
                icon: <Clock className="w-8 h-8 text-orange-500" />,
                title: "Manual Processing Takes Days",
                description: "Editing 500 SKUs in Photoshop? That's 40+ hours of work. Your time is worth more than $2/image."
              },
              {
                icon: <span className="text-2xl">💸</span>,
                title: "Designers Are Expensive",
                description: "Hiring a VA or designer costs $2-5 per image. For a 1000-product catalog, that's $5,000."
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              >
                ...
                <button className={`w-full py-3 px-4 rounded-lg font-semibold mb-4 ${
                  plan.popular 
      ...
      <section className="py-20 bg-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The numbers don't lie—automation wins every time
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                quote: "Processed 800 SKUs in one afternoon. Before Masterpost, this would've taken my VA 2 weeks. Already saved $1,500.",
                name: "Juan López",
                title: "Amazon FBA Seller",
                badge: "Verified Seller"
              },
              {
                quote: "The Amazon pipeline is *chef's kiss*. Zero rejections since I started using it. Compliance issues are a thing of the past.",
                name: "Sarah Chen",
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-purple-700 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6, delay: 0.4 }}
          >
            <button className="bg-white text-purple-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-lg text-lg transition-colors duration-200 flex items-center gap-2 mx-auto mb-8">
